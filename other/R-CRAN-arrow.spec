...
Source1:          https://raw.githubusercontent.com/apache/arrow/main/r/configure
...
mv %{SOURCE1} %{packname}/ && chmod +x %{packname}/configure
sed -i -e '/check-versions/,+2d' %{packname}/configure
sed -i 's|LIB_DIR="$1/lib"|LIB_DIR="%{_libdir}"|' %{packname}/configure
