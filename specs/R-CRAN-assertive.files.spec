%global packname  assertive.files
...
Version:          0.0.2
Release:          3%{?dist}
Summary:          Assertions to Check Properties of Files
...
%description
A set of predicates and assertions for checking the properties of files
and connections.  This is mainly for use by other package developers who
