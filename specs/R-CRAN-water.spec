...
Version:          0.8
Release:          2%{?dist}
Summary:          Actual Evapotranspiration with Energy Balance Models
...
%description
Tools and functions to calculate actual Evapotranspiration using surface
