...
Summary:          Vehicle Routing Problem Solver Built on 'PyVRP'
...
%description
A 'tidyverse'-style interface to high-performance vehicle routing problem
(VRP) solving. Vendors the C++ core of the 'PyVRP' solver
