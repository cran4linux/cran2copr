...
Version:          2.1
Release:          1%{?dist}
Summary:          Nonparametric Analysis of Longitudinal Data in FactorialExperiments
...
distributional assumptions, and are applicable to a variety of data types
(continuous, discrete, purely ordinal, and dichotomous).  Such methods are
also robust with respect to outliers and for small sample sizes.
