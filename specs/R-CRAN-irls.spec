...
Summary:          Generalised Linear Models via Iteratively Reweighted Least Squares
...
(ISBN:9780412317606), either for a single model or many regression models
