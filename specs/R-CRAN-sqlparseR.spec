...
Summary:          Wrapper for 'Python' Module 'sqlparse': Parse, Split, and Format'SQL'
...
<https://github.com/andialbrecht/sqlparse>. It allows parsing, splitting,
