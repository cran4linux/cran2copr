...
Summary:          Wrapper for Interactive and Static Data Visualization
...
%description
Provides a fast and consistent general-purpose wrapper for arranging
microdata and generating interactive and static visualizations. Offers a
library of graphical functions with a highly configurable and simple
syntax. Features include HTML tables, time series, bar and pie charts, and
maps supported by various JavaScript libraries. Allows seamless
transitions between interactive and static graphics without changing the
core syntax. Originally developed to standardize the publication of
official statistics at the National University of Colombia
<https://unal.edu.co>. Spanish: Proporciona una herramienta de propósito
general rápida y consistente para organizar microdatos y generar
visualizaciones interactivas y estáticas. Ofrece una biblioteca de
funciones gráficas con una sintaxis simple y altamente configurable.
Permite transiciones fluidas entre gráficos interactivos y estáticos sin
cambiar la sintaxis base. Desarrollado originalmente para estandarizar la
publicación de estadísticas oficiales en la Universidad Nacional de
Colombia <https://unal.edu.co>.
