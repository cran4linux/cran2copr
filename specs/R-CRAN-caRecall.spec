...
Summary:          Government of Canada Vehicle Recalls Database API Wrapper
...
%description
Provides API access to the Government of Canada Vehicle Recalls Database
<https://tc.api.canada.ca/en/detail?api=VRDB> used by the Defect
