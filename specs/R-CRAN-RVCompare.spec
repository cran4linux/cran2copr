...
Arza (2021) <https://github.com/EtorArza/RVCompare-paper/releases>. Given
the observed samples of two random variables X_A and X_B, it can compute
the cumulative difference-plot (see E. Arza (2021)
<https://github.com/EtorArza/RVCompare-paper/releases> for details). Uses
bootstrap and DKW-bounds to compute the confidence bands of the cumulative
