...
'renderGlassTabs()', URL bookmarking, responsive overflow modes, optional
touch gestures, reduced-motion support, and compact mode for dashboard
card layouts. 'glassTabCondition()' generates 'conditionalPanel()'
condition strings without needing to recall the internal input key
pattern. 'glasstabs_news()' displays the release notes from the R console.
...
dashboards and 'bslib' themed applications. An experimental 'glassPage()'
helper provides a thin wrapper around a fillable 'bslib' page when 'bslib'
is installed. For full documentation and examples see Arthur (2026)
