...
Summary:          Interactive Dataset Explorer for 'R' and 'SAS' and Other Data Formats
...
%description
A 'Shiny' application that provides nice interface for browsing,
exploring, summarising, and converting datasets stored in 'SAS'
(.sas7bdat, .xpt), CSV (.csv), and 'R' (.rds) formats.  Users can register
multiple directory-based libraries, interactively filter data using
'dplyr' expressions, inspect per-variable statistics, and export datasets
to Excel, JSON, CSV, 'R' data, or 'SAS' transport formats.
