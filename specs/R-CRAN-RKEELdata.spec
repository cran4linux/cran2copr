...
Summary:          Datasets from 'KEEL' for it Use in 'RKEEL'
...
includes the datasets from 'KEEL' in .dat format for its use in 'RKEEL'
package. For more information about 'KEEL', see <http://www.keel.es/>.
