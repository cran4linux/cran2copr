...
Summary:          Airborne Point Cloud Data Manipulation and Visualization for Forestry Applications
...
Read/write 'las' and 'laz' files, computation of metrics in area based
approach, point filtering, artificial point reduction, classification from
