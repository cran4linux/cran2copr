...
Summary:          Perform Rosenbaum bounds sensitivity tests for matched andunmatched data.
...
multiple matched controls. Package is also designed to work with the
Matching package and operate on Match() objects.
