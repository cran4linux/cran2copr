...
%description
Provides reproducible methods for experimental design and treatment
allocation in biomedical, veterinary, agricultural, and clinical research.
Includes simple, fixed-block, variable-block, stratified,
...
designs. Also provides allocation summaries, balance diagnostics, schedule
export, and visualization. The methods are based on established principles
of randomization and experimental design; see Rosenberger and Lachin
(2015, ISBN:9781118742242) and Jones and Kenward (2014,
ISBN:9781439861424).
