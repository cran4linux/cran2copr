...
%global packname  outlierspinner
...
Summary:          Geometric Multivariate Outlier Detection via Random Directional Probing
...
%description
Provides tools for multivariate outlier detection based on geometric
properties of multivariate data using random directional projections.
...
Visualization utilities are included to summarize directional
contributions for extreme observations.
