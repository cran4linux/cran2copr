...
BuildRequires:    R-CRAN-statsExpressions >= 1.5.3
BuildRequires:    R-CRAN-paletteer >= 1.5.0
...
BuildRequires:    R-CRAN-ggside >= 0.2.3
...
Requires:         R-CRAN-statsExpressions >= 1.5.3
Requires:         R-CRAN-paletteer >= 1.5.0
