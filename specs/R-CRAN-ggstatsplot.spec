...
BuildRequires:    R-CRAN-statsExpressions >= 1.6.1
...
BuildRequires:    R-CRAN-parameters >= 0.23.0
...
Requires:         R-CRAN-statsExpressions >= 1.6.1
...
Requires:         R-CRAN-parameters >= 0.23.0
