...
sections. 'QCAcluster' allows researchers to supplement the analysis of
pooled the data with a differentiated perspective focusing on selected
...
series) to perform partition-specific truth table minimization. Empirical
