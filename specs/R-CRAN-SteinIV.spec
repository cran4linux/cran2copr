...
Version:          0.1.1
Release:          1%{?dist}
Summary:          Semi-Parametric Stein-Like Estimator with Instrumental Variables
...
%description
Routines for computing different types of linear estimators, based on
