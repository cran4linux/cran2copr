...
version of BSL (semiBSL, An et al. (2020)
<doi:10.1007/s11222-019-09904-x>) is more robust to non-normal summary
statistics. BSLmisspec (Frazier et al. 2021
<doi:10.1080/10618600.2021.1875839>) estimates the Gaussian synthetic
likelihood whilst acknowledging that there may be incompatibility between
the model and the observed summary statistic. Shrinkage estimation can
help to decrease the number of model simulations when the dimension of the
summary statistic is high (e.g., BSLasso, An et al. (2019)
