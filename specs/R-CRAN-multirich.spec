...
Summary:          Calculate Multivariate Richness via UTC and sUTC
...
%description
Functions to calculate Unique Trait Combinations (UTC) and scaled Unique
Trait Combinations (sUTC) as measures of multivariate richness. The
