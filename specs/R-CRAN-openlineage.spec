...
Summary:          Create and Emit 'OpenLineage' Events
...
%description
Construct and validate run events that follow the 'OpenLineage'
specification <https://openlineage.io/>. Model run lifecycles, datasets,
and extensible facets with protocol-aware 'R' objects. Serialize events
into deterministic JavaScript Object Notation (JSON) while preserving wire
field names. Deliver events synchronously over Hypertext Transfer Protocol
(HTTP) with authentication and retries, or use offline transports for
