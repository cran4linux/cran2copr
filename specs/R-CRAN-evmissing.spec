...
presence of missing values based on Simpson and Northrop (2026)
<doi:10.1002/env.70075>. A Generalised Extreme Value distribution is
fitted to block maxima using maximum likelihood estimation, with the
