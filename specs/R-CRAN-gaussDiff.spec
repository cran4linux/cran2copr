...
Version:          1.1
Release:          3%{?dist}
Summary:          Difference measures for multivariate Gaussian probabilitydensity functions
...
density functions, such as the Euclidea mean, the Mahalanobis distance,
