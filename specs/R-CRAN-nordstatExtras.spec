...
%global packname  nordstatExtras
...
Summary:          Shared 'SQLite' Cache Backend for the 'nordstat' Package Family
...
%description
Provides a SQLite-backed cell-level cache that can be used as a drop-in
backend by the nordstat family of packages ('rKolada', 'rTrafa', and
