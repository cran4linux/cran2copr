...
Summary:          Unified Interface for Large Language Model Interactions
...
BuildRequires:    R-CRAN-tidyprompt 
Requires:         R-CRAN-cli 
...
Requires:         R-CRAN-tidyprompt 

%description
Provides a unified interface for interacting with Large Language Models
(LLMs) through various providers including OpenAI
