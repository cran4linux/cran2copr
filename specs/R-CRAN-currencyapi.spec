...
Summary:          Client for the 'currencyapi.com' Currency Conversion API
...
%description
An R client for the 'currencyapi.com' currency conversion API. The API
