...
clusterability are provided. Moreover, the fundamental clustering problems
suite (FCPS) offers a variety of clustering challenges any algorithm
should handle when facing real world data. Nine of the here presented
artificial datasets were named FCPS in Ultsch, A.: "Clustering with SOM:
U*C", In Workshop on Self-Organizing Maps, 2005.
