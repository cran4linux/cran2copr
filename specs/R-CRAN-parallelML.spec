...
Summary:          A Parallel-Voting Algorithm for many Classifiers
...
we return much faster predictions than the regular machine learning
algorithm and possibly even more accurate predictions.
