...
Summary:          Access to 'GeographicLib'
...
%description
Bindings to the 'GeographicLib' C++ library
...
coordinate conversions (geocentric, local Cartesian), and polygon area on
