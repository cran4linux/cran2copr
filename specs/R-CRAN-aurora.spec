...
Summary:          Build Stateless Web Apps with 'plumber2'
...
Requires:         R-core >= 4.1
BuildArch:        noarch
BuildRequires:    R-CRAN-plumber2 >= 0.2.0
...
Requires:         R-CRAN-plumber2 >= 0.2.0
Requires:         R-CRAN-cli 
Requires:         R-CRAN-fs 
...
compiled to a static HTML asset at build time, while 'plumber2' serves the
assets and exposes JSON API routes. Provides functions to scaffold app
