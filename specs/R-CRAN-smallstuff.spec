...
%description
Collection of utility functions supporting statistical modeling,
regression analysis, and network analysis workflows used in data science
research. Includes tools for model selection, matrix operations, graph
analysis, and related statistical computations.
