...
Summary:          Sample Size Calculation Using Cochran's Formula
...
%description
Provides functions to calculate the minimum required sample size for
surveys and studies using Cochran's formula, including the finite
