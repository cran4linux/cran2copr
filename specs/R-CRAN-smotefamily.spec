...
Summary:          A Collection of Oversampling Techniques for Class Imbalance Problem Based on SMOTE
...
nearest neighbor.  Other techniques adopt this concept with other criteria
in order to generate balanced dataset for class imbalance problem.
