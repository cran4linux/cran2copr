...
BuildArch:        noarch
BuildRequires:    R-CRAN-photobiologyWavebands >= 0.5.3
BuildRequires:    R-CRAN-photobiology >= 0.14.3
Requires:         R-CRAN-photobiologyWavebands >= 0.5.3
Requires:         R-CRAN-photobiology >= 0.14.3
