...
Summary:          Empirical Likelihood Analysis for the Cox Model and Yang-Prentice (2005) Model
...
term hazards ratio) model. Empirical likelihood tests within a Cox model,
