...
Summary:          Miscellaneous Functions for Bioinformatics and BayesianStatistics
...
shrinkage estimation: one using a simple weighted method where the user
