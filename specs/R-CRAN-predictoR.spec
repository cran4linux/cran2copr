...
BuildRequires:    R-CRAN-shinydashboardPlus >= 2.0.1
...
BuildRequires:    R-CRAN-colourpicker >= 1.1.0
...
Requires:         R-CRAN-shinydashboardPlus >= 2.0.1
...
Requires:         R-CRAN-colourpicker >= 1.1.0
