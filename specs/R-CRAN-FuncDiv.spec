...
Summary:          Compute Contributional Diversity Metrics
...
%description
Compute alpha and beta contributional diversity metrics, which is intended
for linking taxonomic and functional microbiome data. See 'GitHub'
