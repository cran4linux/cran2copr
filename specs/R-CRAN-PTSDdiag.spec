...
Disorder) diagnostic criteria using PCL-5 (PTSD Checklist for DSM-5) and
CAPS-5 (Clinician-Administered PTSD Scale for DSM-5) data. Functions
...
diagnostic metrics, and comparison with standard DSM-5 criteria.
Redundancy analysis quantifies how many item subsets perform equivalently,
through plateau sizes and bootstrap stability, and reports item selection
against the chance baseline of the searched candidate space. A transport
layer allows a site to evaluate subsets derived elsewhere and return only
