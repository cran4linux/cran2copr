...
Summary:          Generalized Process Capability Indices under Progressive Type-II Censoring
...
and Generalized Process Capability Indices (GPCIs) under Progressive
Type-II censored data using the MleCensoR package. Accepts user-supplied
probability density functions (PDF/PMF), cumulative distribution functions
(CDF), and survival functions (SF). Computes classical and generalized
...
90%%, 95%%, and 99%% levels of significance. Computes Standard Errors, Mean
Squared Error (MSE), Bias, and Coverage Probabilities for model parameters
and capability indices. References: Balakrishnan & Aggarwala (2000)
<doi:10.1007/978-1-4612-1186-0>, Maiti, Saha & Nanda (2010)
