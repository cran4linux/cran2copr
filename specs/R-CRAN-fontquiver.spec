...
BuildArch:        noarch
BuildRequires:    R-CRAN-fontBitstreamVera >= 0.1.0
BuildRequires:    R-CRAN-fontLiberation >= 0.1.0
Requires:         R-CRAN-fontBitstreamVera >= 0.1.0
Requires:         R-CRAN-fontLiberation >= 0.1.0
