...
another matrix Y.  Previously, this could be done by binding the two
...
of X, and likewise for Y. pdist strictly computes distances across the two
matrices, not within the same matrix, making computations significantly
