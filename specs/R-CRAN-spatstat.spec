...
BuildArch:        noarch
BuildRequires:    R-CRAN-spatstat.explore >= 3.4.2
BuildRequires:    R-CRAN-spatstat.geom >= 3.3.6
BuildRequires:    R-CRAN-spatstat.model >= 3.3.5
BuildRequires:    R-CRAN-spatstat.random >= 3.3.3
BuildRequires:    R-CRAN-spatstat.linnet >= 3.2.5
BuildRequires:    R-CRAN-spatstat.data >= 3.1.6
BuildRequires:    R-CRAN-spatstat.utils >= 3.1.3
BuildRequires:    R-CRAN-spatstat.univar >= 3.1.2
BuildRequires:    R-utils 
Requires:         R-CRAN-spatstat.explore >= 3.4.2
Requires:         R-CRAN-spatstat.geom >= 3.3.6
Requires:         R-CRAN-spatstat.model >= 3.3.5
Requires:         R-CRAN-spatstat.random >= 3.3.3
Requires:         R-CRAN-spatstat.linnet >= 3.2.5
Requires:         R-CRAN-spatstat.data >= 3.1.6
Requires:         R-CRAN-spatstat.utils >= 3.1.3
Requires:         R-CRAN-spatstat.univar >= 3.1.2
Requires:         R-utils 
