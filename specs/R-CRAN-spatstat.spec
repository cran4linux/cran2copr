...
BuildArch:        noarch
BuildRequires:    R-CRAN-spatstat.geom >= 3.3.5
BuildRequires:    R-CRAN-spatstat.explore >= 3.3.4
BuildRequires:    R-CRAN-spatstat.model >= 3.3.4
...
Requires:         R-CRAN-spatstat.geom >= 3.3.5
Requires:         R-CRAN-spatstat.explore >= 3.3.4
Requires:         R-CRAN-spatstat.model >= 3.3.4
