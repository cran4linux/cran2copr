...
BuildArch:        noarch
BuildRequires:    R-CRAN-spatstat.explore >= 3.8.0
BuildRequires:    R-CRAN-spatstat.geom >= 3.7.3
BuildRequires:    R-CRAN-spatstat.model >= 3.7.0
BuildRequires:    R-CRAN-spatstat.linnet >= 3.5.0
BuildRequires:    R-CRAN-spatstat.random >= 3.4.5
BuildRequires:    R-CRAN-spatstat.utils >= 3.2.2
BuildRequires:    R-CRAN-spatstat.data >= 3.1.9
BuildRequires:    R-CRAN-spatstat.univar >= 3.1.7
BuildRequires:    R-utils 
Requires:         R-CRAN-spatstat.explore >= 3.8.0
Requires:         R-CRAN-spatstat.geom >= 3.7.3
Requires:         R-CRAN-spatstat.model >= 3.7.0
Requires:         R-CRAN-spatstat.linnet >= 3.5.0
Requires:         R-CRAN-spatstat.random >= 3.4.5
Requires:         R-CRAN-spatstat.utils >= 3.2.2
Requires:         R-CRAN-spatstat.data >= 3.1.9
Requires:         R-CRAN-spatstat.univar >= 3.1.7
Requires:         R-utils 
