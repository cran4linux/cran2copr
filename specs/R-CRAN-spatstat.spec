...
BuildArch:        noarch
BuildRequires:    R-CRAN-spatstat.model >= 3.2.3
BuildRequires:    R-CRAN-spatstat.random >= 3.1.4
BuildRequires:    R-CRAN-spatstat.geom >= 3.1.0
BuildRequires:    R-CRAN-spatstat.explore >= 3.1.0
BuildRequires:    R-CRAN-spatstat.linnet >= 3.1.0
BuildRequires:    R-CRAN-spatstat.utils >= 3.0.2
BuildRequires:    R-CRAN-spatstat.data >= 3.0.1
BuildRequires:    R-utils 
Requires:         R-CRAN-spatstat.model >= 3.2.3
Requires:         R-CRAN-spatstat.random >= 3.1.4
Requires:         R-CRAN-spatstat.geom >= 3.1.0
Requires:         R-CRAN-spatstat.explore >= 3.1.0
Requires:         R-CRAN-spatstat.linnet >= 3.1.0
