...
BuildArch:        noarch
BuildRequires:    R-CRAN-spatstat.geom >= 3.3.3
BuildRequires:    R-CRAN-spatstat.random >= 3.3.2
BuildRequires:    R-CRAN-spatstat.explore >= 3.3.2
BuildRequires:    R-CRAN-spatstat.model >= 3.3.2
BuildRequires:    R-CRAN-spatstat.linnet >= 3.2.2
...
Requires:         R-CRAN-spatstat.geom >= 3.3.3
Requires:         R-CRAN-spatstat.random >= 3.3.2
Requires:         R-CRAN-spatstat.explore >= 3.3.2
Requires:         R-CRAN-spatstat.model >= 3.3.2
Requires:         R-CRAN-spatstat.linnet >= 3.2.2
