...
Version:          1.0.2
Release:          1%{?dist}
Summary:          Geometric Morphometrics Analyses
...
BuildRequires:    R-CRAN-Morpho >= 2.5.0
...
<doi:10.1002/ajpa.23493>), and functions to import and export the
coordinates of landmarks and 3D paths into 'landmarkAscii' and 'am' format
files.
