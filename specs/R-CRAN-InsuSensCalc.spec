...
%description
Facilitates the calculation of 40 different insulin sensitivity indices
based on fasting, oral glucose tolerance test (OGTT), lipid (adipose),
tracer (palmitate and glycerol rate), and DXA (fat mass) measurement
values. Enables easy and accurate assessment of insulin sensitivity,
...
<doi:10.1002/oby.23503>, Suleman (2024) <doi:10.1210/clinem/dgae275>, and
