...
models on the canonical variates. See reference - Cruz-Cano, Cohen, and
Mead-Morse (2024) "Canonical Correlation Analysis of Survey data: the
SurveyCC R package" The R Journal under review.
