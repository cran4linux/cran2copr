...
BuildRequires:    R-CRAN-htmlwidgets >= 1.4.0
BuildRequires:    R-CRAN-kableExtra >= 1.3.0
BuildRequires:    R-CRAN-tidyselect >= 1.1.0
BuildRequires:    R-CRAN-dplyr >= 1.0.0
BuildRequires:    R-CRAN-tidyr >= 1.0.0
BuildRequires:    R-CRAN-tabxplor >= 1.0.0
BuildRequires:    R-CRAN-ggrepel >= 0.9.0
BuildRequires:    R-CRAN-ggiraph >= 0.7.0
BuildRequires:    R-CRAN-forcats >= 0.5.0
BuildRequires:    R-CRAN-rlang >= 0.4.0
BuildRequires:    R-CRAN-widgetframe >= 0.3.0
...
Requires:         R-CRAN-htmlwidgets >= 1.4.0
Requires:         R-CRAN-kableExtra >= 1.3.0
Requires:         R-CRAN-tidyselect >= 1.1.0
Requires:         R-CRAN-dplyr >= 1.0.0
Requires:         R-CRAN-tidyr >= 1.0.0
Requires:         R-CRAN-tabxplor >= 1.0.0
Requires:         R-CRAN-ggrepel >= 0.9.0
Requires:         R-CRAN-ggiraph >= 0.7.0
Requires:         R-CRAN-forcats >= 0.5.0
Requires:         R-CRAN-rlang >= 0.4.0
Requires:         R-CRAN-widgetframe >= 0.3.0
...
preventing over-interpretation. Graphs are made with 'ggplot2', which
