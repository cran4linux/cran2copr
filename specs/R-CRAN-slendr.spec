...
software (Haller et al. 2019) <doi:10.1093/molbev/msy228> behind the
...
population genetics simulator 'msprime' (Baumdicker et al. 2022)
...
functionality via an R interface to the 'Python' module 'tskit' (Kelleher
et al. 2019) <doi:10.1038/s41588-019-0483-y>. Complete model
