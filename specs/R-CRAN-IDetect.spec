...
Summary:          Isolate-Detect Method for Multiple Change-Point Detection
...
%description
The IDetect provides efficient implementation of the ID methodology for
...
signal, piecewise-constant signal with a heavy-tailed noise, continuous
piecewise-linear signal, continuous piecewise-linear signal with a
heavy-tailed noise.
