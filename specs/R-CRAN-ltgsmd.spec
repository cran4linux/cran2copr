...
%description
Implements the latent true-score and target-population anchored geometric
standardized mean difference (LTG-SMD) framework for two-group effect-size
analysis. Provides plug-in estimation, analytic delta-method confidence
intervals using a sample fourth-moment plug-in, bias-corrected and
bias-corrected-accelerated nonparametric bootstrap confidence intervals
with study x group stratification, denominator-sensitivity profiles, and
