...
'timeSeries', 'tsibble', 'tibbletime' etc.) --- Key Features: --- (1)
...
linear prediction, model fitting and testing exclusion restrictions. (4)
Advanced time-computations: Fast (sequences of) lags / leads, and (lagged
/ leaded, iterated, quasi-, log-) differences and (compounded) growth
rates on (irregular) time series and panel data. Multivariate auto-,
...
splitting, extraction / subsetting, data-apply, and generalized recursive
