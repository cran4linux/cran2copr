...
Summary:          Latent Space-Based Transfer Learning
...
BuildRequires:    R-CRAN-ScreeNOT 
BuildRequires:    R-CRAN-RcppEigen 
Requires:         R-CRAN-Rcpp >= 1.0.11
Requires:         R-CRAN-ScreeNOT 
Requires:         R-CRAN-RcppEigen 

%description
Implements transfer learning methods for low-rank matrix estimation. These
...
described by McGrath et al. (2024) <doi:10.48550/arXiv.2412.20605>.
