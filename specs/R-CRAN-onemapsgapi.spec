...
%description
An R wrapper for the 'OneMap.Sg' API <https://docs.onemap.sg/>. Functions
help users query data from the API and return raw JSON data in "tidy"
formats. Support is also available for users to retrieve data from
