...
Summary:          Pseudo Maximum Likelihood Estimation for Semi-Competing Risks Data
...
%description
Implements two-stage pseudo maximum likelihood estimation (PMLE) for
copula-based regression models with semi-competing risks data. The
