...
Summary:          Sampling Design and Estimation Methods for Natural Resource Management
...
%description
Provides functions for probability and non-probability sampling design,
sample selection, and population estimation tailored to natural resource
...
convenience, judgement-based, and quota sampling. Estimation functions
cover means, totals, ratio estimators, regression estimators, and the
