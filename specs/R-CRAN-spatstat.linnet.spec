...
BuildRequires:    R-CRAN-spatstat.geom >= 3.2.9.028
BuildRequires:    R-CRAN-spatstat.explore >= 3.2.7.006
BuildRequires:    R-CRAN-spatstat.random >= 3.2.3.003
BuildRequires:    R-CRAN-spatstat.model >= 3.2.11.005
...
Requires:         R-CRAN-spatstat.geom >= 3.2.9.028
Requires:         R-CRAN-spatstat.explore >= 3.2.7.006
Requires:         R-CRAN-spatstat.random >= 3.2.3.003
Requires:         R-CRAN-spatstat.model >= 3.2.11.005
