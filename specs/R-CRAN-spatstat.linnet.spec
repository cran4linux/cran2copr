...
BuildRequires:    R-CRAN-spatstat.geom >= 3.8.3
BuildRequires:    R-CRAN-spatstat.explore >= 3.8.3
BuildRequires:    R-CRAN-spatstat.model >= 3.7.2
BuildRequires:    R-CRAN-spatstat.random >= 3.5.2
BuildRequires:    R-CRAN-spatstat.utils >= 3.2.5
...
Requires:         R-CRAN-spatstat.geom >= 3.8.3
Requires:         R-CRAN-spatstat.explore >= 3.8.3
Requires:         R-CRAN-spatstat.model >= 3.7.2
Requires:         R-CRAN-spatstat.random >= 3.5.2
Requires:         R-CRAN-spatstat.utils >= 3.2.5
