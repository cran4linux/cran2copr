...
BuildRequires:    R-CRAN-spatstat.explore >= 3.8
BuildRequires:    R-CRAN-spatstat.geom >= 3.7.3
BuildRequires:    R-CRAN-spatstat.model >= 3.7
...
Requires:         R-CRAN-spatstat.explore >= 3.8
Requires:         R-CRAN-spatstat.geom >= 3.7.3
Requires:         R-CRAN-spatstat.model >= 3.7
