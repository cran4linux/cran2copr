...
Summary:          Tools for Analysis, Design, and Operation of Water SupplyStorages
...
multi-objective reservoirs using deterministic and stochastic dynamic
programming; generate inflow replicates using parametric and
