...
BuildArch:        noarch
BuildRequires:    R-CRAN-nanoparquet >= 0.5.0
BuildRequires:    R-CRAN-cli 
BuildRequires:    R-CRAN-dplyr 
BuildRequires:    R-CRAN-rlang 
BuildRequires:    R-CRAN-tibble 
BuildRequires:    R-utils 
Requires:         R-CRAN-nanoparquet >= 0.5.0
Requires:         R-CRAN-cli 
...
Poverty Estimates (SAIPE), community data from the ACS 5-Year Estimates,
...
simplifies downloading, caching, and filtering education finance data by
year and state, enabling researchers and analysts to explore K-12
education funding patterns, revenue sources, expenditure categories, and
