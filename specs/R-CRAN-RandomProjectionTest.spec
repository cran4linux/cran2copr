...
%global packname  RandomProjectionTest
...
Summary:          Two-Sample Test in High Dimensions using Random Projection
...
%description
Performs the random projection test (Lopes et al., (2011)
<doi:10.48550/arXiv.1108.2401>) for the one-sample and two-sample
