...
Version:          0.2.0
Release:          2%{?dist}
Summary:          Produce Standard/Formalized Demographics Tables
...
BuildRequires:    R-CRAN-knitr >= 1.18.0
...
%description
Augment clinical data with metadata to create output used in conventional
