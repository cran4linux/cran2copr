...
Requires:         R-core >= 3.2
BuildArch:        noarch
BuildRequires:    R-CRAN-sjmisc >= 2.8.1
BuildRequires:    R-CRAN-sjlabelled >= 1.1.0
BuildRequires:    R-CRAN-dplyr >= 0.8.1
BuildRequires:    R-CRAN-insight >= 0.4.1
BuildRequires:    R-CRAN-performance >= 0.3.0
BuildRequires:    R-CRAN-bayestestR >= 0.2.5
...
Requires:         R-CRAN-sjmisc >= 2.8.1
Requires:         R-CRAN-sjlabelled >= 1.1.0
Requires:         R-CRAN-dplyr >= 0.8.1
Requires:         R-CRAN-insight >= 0.4.1
Requires:         R-CRAN-performance >= 0.3.0
Requires:         R-CRAN-bayestestR >= 0.2.5
