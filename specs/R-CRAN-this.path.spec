...
Summary:          Get Executing Script's Path, from 'RStudio', 'RGui', 'Rscript' (Command-Line / / Terminal), and when using 'source'
...
when running 'Rscript' from the command-line / / terminal.
