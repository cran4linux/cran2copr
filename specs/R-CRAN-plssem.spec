...
are under development. References: Lohmöller, J.-B. (1989,
ISBN:9783790803002). "Latent Variable Path Modeling with Partial Least
Squares." Dijkstra, T. K., & Henseler, J. (2015).
...
squares path modeling using ordinal categorical indicators."
