...
Version:          0.7
Release:          1%{?dist}
Summary:          Birnbaum-Saunders Model Based on Skew-Normal Distribution
...
parameter Birnbaum-Saunders model based on Skew-Normal Distribution.
Additionally, it provides the random number generator for the mixture of
