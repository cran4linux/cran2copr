...
``Practical Tools for Designing and Weighting Survey Samples'' (2nd
...
designs. Other functions compute variance components for multistage
designs and sample sizes in two-phase designs. A number of example data
sets are included.
