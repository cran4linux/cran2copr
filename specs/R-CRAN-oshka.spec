...
Version:          0.1.2
Release:          1%{?dist}
Summary:          Recursive Quoted Language Expansion
...
continues until only symbols that point to non-language objects remain.
The resulting quoted language can then be evaluated normally.  This
