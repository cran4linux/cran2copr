...
Version:          0.2
Release:          2%{?dist}
Summary:          Debugging with Restore Points
...
%description
Debugging with restore points instead of break points. A restore point
stores all local variables when called inside a function. The stored
