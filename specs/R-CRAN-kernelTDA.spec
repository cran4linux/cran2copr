...
<https://www.csie.ntu.edu.tw/~cjlin/libsvm/>, and on its R implementation
'e1071'. Additionally, it allows to compute Wasserstein distance between
persistence diagrams with an arbitrary ground metric, building an R
interface for the C++ library 'HERA'
