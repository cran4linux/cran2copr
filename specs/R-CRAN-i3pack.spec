...
Summary:          Incentives for Inter- And Intra-Party Electoral Competition
...
BuildRequires:    R-CRAN-STV >= 1.0.2
...
Requires:         R-CRAN-STV >= 1.0.2

%description
Suite of functions that help simulate elections under different electoral
systems, which are then used to compute incentives generated by these
systems in terms of the inter- and intra-party dimensions of electoral
competition.
