...
Summary:          Network Meta-Analysis using Integrated Nested Laplace Approximations
...
different network meta-analysis dataset. 'INLA' package can be obtained
from <https://www.r-inla.org>.
