...
Version:          0.2.7
Release:          1%{?dist}
Summary:          Read, Validate, and Analyze Files in the General Transit FeedSpecification
...
Please see the GTFS documentation here for more detail:
<http://gtfs.org/>.
