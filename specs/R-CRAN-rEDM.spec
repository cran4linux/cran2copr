...
at the Sugihara Lab ('UCSD/SIO'). Primary methods include 'Simplex'
projection from Sugihara & May (1990) <doi:10.1038/344734a0>, Sequential
locally-weighted global linear maps 'S-map': Sugihara (1994)
...
embedding' from Ye & Sugihara (2016) <doi:10.1126/science.aag0863>.
