...
Version:          0.1.0
Release:          2%{?dist}
Summary:          Interactive Document for Working with Discriminant Analysis
...
%description
An interactive document on the topic of linear discriminant analysis using
...
%doc %{rlibdir}/%{packname}/MLDAShiny.Rmd
