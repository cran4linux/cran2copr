...
BuildRequires:    R-CRAN-lava >= 1.9.1
BuildRequires:    R-CRAN-RcppArmadillo >= 0.12.8.0
...
Requires:         R-CRAN-lava >= 1.9.1
Requires:         R-CRAN-RcppArmadillo >= 0.12.8.0
...
Modern methods for survival analysis, including regression modelling (Cox,
Fine-Gray, Ghosh-Lin, Binomial regression) with fast computation of
influence functions.
