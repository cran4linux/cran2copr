...
Summary:          Multi-Resolution Scanning for Cross-Sample and Cross-Group Differences
...
%description
Implements the multi-resolution scanning (MRS) method for cross-sample
distribution comparisons, as described in Soriano and Ma (2017)
