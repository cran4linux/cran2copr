...
Summary:          Generalized Process Capability Indices via EM Algorithm under Progressive Type-II Censoring
...
estimation under progressive Type-II censored data (Balakrishnan and
Aggarwala (2000) <doi:10.1007/978-1-4612-1186-0>) and computes Generalized
Process Capability Indices (GPCIs). Uses the 'UniCensorEM' package for EM
estimation. Supports classical and generalized capability indices
including Cpy (Maiti et al. (2010) <doi:10.1080/16843703.2010.11673233>),
Cp, Cpk, Cpu, Cpl, Cpm, Cpmk, Spmk (Dey and Saha (2019)
<doi:10.1007/s41872-019-00081-4>), CpTk (Saha et al. (2018)
<doi:10.1080/21681015.2018.1437793>), Cpc, CNpmc (Alotaibi et al. (2022)
...
convergence probability, and bootstrap confidence intervals at 90 percent,
