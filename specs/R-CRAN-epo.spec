...
Summary:          Enhanced Portfolio Optimization (EPO)
...
%description
Implements the Enhanced Portfolio Optimization (EPO) method as described
in Pedersen, Babu and Levine (2021) <doi:10.2139/ssrn.3530390>.
