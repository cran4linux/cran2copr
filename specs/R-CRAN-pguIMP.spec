...
Summary:          Visually Guided Preprocessing of Bioanalytical Laboratory Data
...
%description
Reproducible cleaning of biomedical laboratory data using visualization,
error correction, and transformation methods implemented as interactive R
notebooks. A detailed description of the methods ca ben found in Malkusch,
S., Hahnefeld, L., Gurke, R. and J. Lotsch. (2021)
