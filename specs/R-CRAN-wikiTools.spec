...
BuildRequires:    R-CRAN-netCoin 
BuildRequires:    R-CRAN-evolMap 
Requires:         R-CRAN-curl 
Requires:         R-CRAN-httr 
Requires:         R-CRAN-jsonlite 
Requires:         R-CRAN-collections 
Requires:         R-CRAN-netCoin 
Requires:         R-CRAN-evolMap 

%description
A set of wrappers intended to check, read and download information from
the Wikimedia sources. It is specifically created to work with names of
celebrities, in which case their information and statistics can be
