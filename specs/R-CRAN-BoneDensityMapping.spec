...
to 3D bone models in a reproducible manner. Processing can be performed at
the individual bone or group level. Also includes tools for visualizing
the bone density estimates. Example methods are described in Telfer et
al., (2021) <doi:10.1002/jor.24792>, Telfer et al., (2021)
