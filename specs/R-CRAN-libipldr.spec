...
Summary:          R Bindings to the 'Rust' 'IPLD' Library
...
%description
Provides R bindings to decode DAG-CBOR (Directed Acyclic Graph Concise
Binary Object Representation) encoded data, CIDs (Content Identifiers),
