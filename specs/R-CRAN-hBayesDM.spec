...
Requires:         R-core >= 4.4
BuildArch:        noarch
BuildRequires:    R-CRAN-loo >= 2.7
BuildRequires:    R-CRAN-posterior >= 1.6
BuildRequires:    R-CRAN-bayesplot >= 1.11
BuildRequires:    R-methods 
BuildRequires:    R-grid 
BuildRequires:    R-parallel 
BuildRequires:    R-CRAN-ggplot2 
BuildRequires:    R-CRAN-data.table 
Requires:         R-CRAN-loo >= 2.7
Requires:         R-CRAN-posterior >= 1.6
Requires:         R-CRAN-bayesplot >= 1.11
Requires:         R-methods 
Requires:         R-grid 
Requires:         R-parallel 
