...
Version:          0.0.4
Release:          1%{?dist}
Summary:          Use Data from Published Plots in R
...
%description
Import data from a digital image; it requires user input for calibration
and to locate the data points. The end result is similar to 'DataThief'
