...
Summary:          Exact Multinomial Test: Goodness-of-Fit Test for DiscreteMultivariate data
...
to have occurred under the assumption of an ab-initio model. A p-value can
