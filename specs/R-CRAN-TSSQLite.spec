...
Version:          2015.4.1
Release:          1%{?dist}
Summary:          'TSdbi' Extensions for 'SQLite'
...
%description
An 'SQLite' interface for 'TSdbi'. Comprehensive examples of all the 'TS*'
...
%doc %{rlibdir}/%{packname}/testWithSQLiteServer
