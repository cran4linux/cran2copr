...
Summary:          Publication-Quality Forest and Funnel Plots with 'ggplot2'
...
%description
A 'ggplot2' extension that creates publication-quality forest and funnel
plots from 'meta' package objects or tidy data frames. Provides custom
'ggproto' geometries for study-level confidence intervals with
