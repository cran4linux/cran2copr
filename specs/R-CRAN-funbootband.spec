...
Summary:          Simultaneous Prediction and Confidence Bands for Time Series Data
...
%description
Provides methods to compute simultaneous prediction and confidence bands
for dense time series data. The implementation builds on the functional
