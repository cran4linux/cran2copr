...
BuildRequires:    R-CRAN-rintcal >= 1.4.1
BuildRequires:    R-CRAN-rlang 
BuildRequires:    R-CRAN-ggplot2 
Requires:         R-CRAN-maps >= 3.4.2.1
Requires:         R-CRAN-rintcal >= 1.4.1
...
Reimer, P.J., 2026. An open-source toolkit for radiocarbon dating and
calibration. Radiocarbon <doi:10.1017/RDC.2026.10221>. The methods follow
