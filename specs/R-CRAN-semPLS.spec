...
Requires:         R-core
BuildArch:        noarch
BuildRequires:    R-lattice >= 0.20.5
Requires:         R-lattice >= 0.20.5
...
%doc %{rlibdir}/%{packname}/ECSImeasuremod.csv
%doc %{rlibdir}/%{packname}/ECSIstrucmod.csv
%doc %{rlibdir}/%{packname}/semPLS-intro
%doc %{rlibdir}/%{packname}/SmartPLS
