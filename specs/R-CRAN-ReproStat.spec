...
Summary:          Reproducibility Diagnostics for Statistical Modeling
...
under data perturbations. Implements bootstrap, subsampling, and
...
penalized regression ('glmnet'). Bootstrap perturbation follows 'Efron'
and 'Tibshirani' (1993, ISBN:9780412042317); selection stability follows
'Meinshausen' and 'Buhlmann' (2010)
<doi:10.1111/j.1467-9868.2010.00740.x>; reproducibility framework follows
