...
BuildArch:        noarch
BuildRequires:    R-CRAN-highs >= 1.12.0
BuildRequires:    R-CRAN-MASS 
BuildRequires:    R-CRAN-slam 
BuildRequires:    R-stats 
BuildRequires:    R-graphics 
Requires:         R-CRAN-highs >= 1.12.0
...
<https://www.gurobi.com/getting-started/> and
<https://docs.gurobi.com/projects/optimizer/en/current/reference/r/setup.html>.
We have also included directions in the gurobi_installation file in the
inst folder.
