...
Version:          0.1.4
Release:          1%{?dist}
Summary:          Utilities for Generating SQL Queries from Model Objects
...
%description
Provides utilities for generating SQL queries (particularly CREATE TABLE
statements) from R model objects. The most important use case is
