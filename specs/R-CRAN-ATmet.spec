...
Version:          1.2.1
Release:          1%{?dist}
Summary:          Advanced Tools for Metrology
...
%description
A collection of functions for smart sampling and sensitivity analysis for
metrology applications, including computationally expensive problems.
