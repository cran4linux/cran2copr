...
BuildRequires:    R-CRAN-infer >= 1.0.2
BuildRequires:    R-CRAN-recipes >= 1.0.1
...
BuildRequires:    R-CRAN-workflowsets >= 1.0.0
...
Requires:         R-CRAN-infer >= 1.0.2
Requires:         R-CRAN-recipes >= 1.0.1
...
Requires:         R-CRAN-workflowsets >= 1.0.0
