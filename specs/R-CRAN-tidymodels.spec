...
BuildRequires:    R-CRAN-parsnip >= 1.5.0
BuildRequires:    R-CRAN-dials >= 1.4.3
BuildRequires:    R-CRAN-hardhat >= 1.4.3
BuildRequires:    R-CRAN-yardstick >= 1.4.0
BuildRequires:    R-CRAN-recipes >= 1.3.2
BuildRequires:    R-CRAN-rsample >= 1.3.2
...
BuildRequires:    R-CRAN-rstudioapi >= 0.18.0
...
Requires:         R-CRAN-parsnip >= 1.5.0
Requires:         R-CRAN-dials >= 1.4.3
Requires:         R-CRAN-hardhat >= 1.4.3
Requires:         R-CRAN-yardstick >= 1.4.0
Requires:         R-CRAN-recipes >= 1.3.2
Requires:         R-CRAN-rsample >= 1.3.2
...
Requires:         R-CRAN-rstudioapi >= 0.18.0
