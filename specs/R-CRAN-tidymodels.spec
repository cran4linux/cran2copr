...
BuildRequires:    R-CRAN-modeldata >= 1.2.0
...
BuildRequires:    R-CRAN-parsnip >= 1.1.1
...
BuildRequires:    R-CRAN-rstudioapi >= 0.15.0
...
Requires:         R-CRAN-modeldata >= 1.2.0
...
Requires:         R-CRAN-rstudioapi >= 0.15.0
