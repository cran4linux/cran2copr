...
BuildRequires:    R-CRAN-yardstick >= 1.3.1
BuildRequires:    R-CRAN-modeldata >= 1.3.0
BuildRequires:    R-CRAN-dials >= 1.2.1
...
BuildRequires:    R-CRAN-infer >= 1.0.6
...
Requires:         R-CRAN-yardstick >= 1.3.1
Requires:         R-CRAN-modeldata >= 1.3.0
Requires:         R-CRAN-dials >= 1.2.1
