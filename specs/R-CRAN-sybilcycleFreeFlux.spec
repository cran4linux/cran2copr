...
Version:          2.0.0
Release:          1%{?dist}
Summary:          Cycle-Free Flux Balance Analysis
...
%description
Implement cycle-Free flux balance analysis, flux variability, and Random
Sampling of solution space. Flux balance analysis is a technique to find
