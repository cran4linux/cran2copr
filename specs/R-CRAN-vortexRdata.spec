...
Summary:          Example Data for R Package 'vortexR'
...
%description
Contains selected data from two publications, Campbell 'et' 'al'. (2016)
...
population viability analysis software 'Vortex' and packaged as R objects.
