...
can be found on github: <https://github.com/Illustratien/Wang_2023_TAAG>.
Sample dataset in this package is derived from another publication:
Casadebaig P, Zheng B, Chapman S et al. (2016)
<doi:10.1371/journal.pone.0146385>. For detailed documentation of dataset,
please see on Zenodo <doi:10.5281/zenodo.4729636>. Indices used in this
package are from: Döring TF, Reckling M (2018)
...
<doi:10.1007/BF00285245>. Lin CS, Binns MR (1988). Nassar R, Hühn M
