...
Version:          0.1.4
Release:          1%{?dist}
Summary:          Textual Data Analysis Package used by the TXM Software
...
%description
Statistical exploration of textual corpora using several methods from
