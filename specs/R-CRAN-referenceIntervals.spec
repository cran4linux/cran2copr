%global packname  referenceIntervals
...
calculate appropriate reference ranges (intervals) with confidence
intervals around the limits for diagnostic purposes.
