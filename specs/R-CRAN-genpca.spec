...
Summary:          Generalized Principal Component Analysis
...
BuildRequires:    R-CRAN-eigencore >= 1.0.3
BuildRequires:    R-CRAN-multivarious >= 0.3.0
...
Requires:         R-CRAN-eigencore >= 1.0.3
Requires:         R-CRAN-multivarious >= 0.3.0
...
%description
Generalized PCA and related matrix decompositions in weighted
