...
Summary:          Tamper-Evident Audit Logging for Regulated Environments
...
%description
Provides tamper-evident, hash-chained audit logging for analytical
applications. Every log entry is linked via an 'SHA-256' hash to its
...
instrumentation. For more details see <https://reprostats.org/regulog/>.
...
qualification scripts (IQ, OQ, PQ) for use in validated computerised
systems.
