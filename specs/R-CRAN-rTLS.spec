...
%global packver   0.2.5.6
%global rlibdir   /usr/local/lib/R/library

Name:             R-CRAN-%{packname}
Version:          0.2.5.6
Release:          1%{?dist}%{?buildtag}
Summary:          Processing of Point Clouds Derived from Terrestrial Laser Scanning
...
from terrestrial laser scanning (TLS) also know as terrestrial LiDAR
(Light Detection and Ranging). Its creation is based on key aspects of the
TLS application in forestry and ecology. Currently, the main routines are
...
data.table and 'C++' language and in most of the functions it is possible
