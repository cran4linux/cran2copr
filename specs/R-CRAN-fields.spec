...
and for an overview. All graphics functions focus on using base R
graphics.  The fields source code is deliberately commented and provides
useful explanations of numerical details as a companion to the manual
pages. The commented source code can be viewed by expanding the source
