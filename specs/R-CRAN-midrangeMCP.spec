...
Version:          1.3
Release:          1%{?dist}
Summary:          Multiple Comparisons Procedures Based on Studentized Midrangeand Range Distributions
...
range distributions. The tests are: Tukey Midrange test, Student-Newman-
