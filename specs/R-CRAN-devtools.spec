...
BuildRequires:    R-CRAN-testthat >= 3.3.2
...
BuildRequires:    R-CRAN-fs >= 1.6.7
BuildRequires:    R-CRAN-pkgload >= 1.5.0
...
BuildRequires:    R-CRAN-pak >= 0.9.2
...
Requires:         R-CRAN-testthat >= 3.3.2
...
Requires:         R-CRAN-fs >= 1.6.7
Requires:         R-CRAN-pkgload >= 1.5.0
