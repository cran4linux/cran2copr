...
Summary:          Bayesian Ammi Model for Ordinal Data
...
Main Effects and Multiplicative Model (AMMI) for ordinal data. Biplot with
the averages and regions of confidence can be generated. The chains run in
