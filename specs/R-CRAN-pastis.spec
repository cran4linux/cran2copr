...
Summary:          Phylogenetic Assembly with Soft Taxonomic Inferences
...
BuildRequires:    R-CRAN-caper >= 0.5.0
Requires:         R-CRAN-ape >= 3.0
Requires:         R-CRAN-caper >= 0.5.0

%description
A pre-processor for mrBayes that assimilates sequences, taxonomic
...
the tree constraint can be investigated using conch.
