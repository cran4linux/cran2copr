...
Version:          1.1.0
Release:          3%{?dist}
Summary:          Quantile Comparison for Two-Sample Right-Censored Survival Data
...
BuildRequires:    R-survival >= 2.41
Requires:         R-graphics >= 3.4.0
Requires:         R-stats >= 3.4.0
Requires:         R-survival >= 2.41
