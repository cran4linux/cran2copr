...
Version:          2.2
Release:          2%{?dist}
Summary:          Manage and manipulate large collections of R objects stored astape-like files
...
%description
Storing huge data in RData format causes problems because of the necessity
...
package contains several wrappers of R built-in serialize/unserialize
