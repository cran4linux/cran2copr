...
Summary:          Survival Prediction for Severe Limb Ischaemia (BASIL Model)
...
%description
Predicts survival for patients with severe limb ischaemia using the
