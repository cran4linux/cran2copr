...
Summary:          Kuhn-Tucker and Multiple Discrete-Continuous Extreme ValueModels
...
Bayesian inference (see Stan Development Team, 2019) <http://mc-stan.org>.
The package also implements demand forecasting (Pinjari and Bhat (2011)
<https://repositories.lib.utexas.edu/handle/2152/23880>) and welfare
calculation (Lloyd-Smith (2018) <doi.org/10.1016/j.jocm.2017.12.002>) for
policy simulation.
