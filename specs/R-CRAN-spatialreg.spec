...
BuildRequires:    R-CRAN-spdep >= 1.4.1
...
to now in 'spdep'. These model fitting functions include maximum
likelihood methods for cross-sectional models proposed by 'Cliff' and
'Ord' (1973, ISBN:0850860369) and (1981, ISBN:0850860814), fitting methods
initially described by 'Ord' (1975) <doi:10.1080/01621459.1975.10480272>.
The models are further described by 'Anselin' (1988)
...
articles include extensive lists of references. A recent review is
provided by 'Bivand', 'Millo' and 'Piras' (2021)
