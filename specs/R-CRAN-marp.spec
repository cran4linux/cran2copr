...
and BPT), model-averaged point estimates are calculated using AIC weights.
...
estimation from the individual or "best" model (determined via model
selection) can be retrieved.
