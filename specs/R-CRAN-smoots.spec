...
built-in as a comparison. The methods of the package are described in
Feng, Y., and Gries, T., (2017)
<http://groups.uni-paderborn.de/wp-wiwi/RePEc/pdf/ciepap/WP102.pdf>. A
current version of the paper that is also referred to in the documentation
of the functions is prepared for publication.
